...
| List NFT by DID | `/api/list-nfts-by-did` | This API fetches all the NFTs which belongs to that particular DID | ```curl -X 'GET' 'http://localhost:20004/api/list-nfts-by-did?did=bafybmidqonetmpojlkkrxcxdx3yc5vk2ksf447z54ewuuzxtnebpy4mqkm' -H 'accept: application/json'``` |
