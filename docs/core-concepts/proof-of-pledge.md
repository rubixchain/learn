...
| **Decentralization** | If the staking amount is high, there will be higher chance to become a validator | pledge amount is equal, gives equal chance to become validator for all the nodes |
...
| **Lock-in** | Long-term staking often required | Pledge can be revoked if replaced by another validator |
