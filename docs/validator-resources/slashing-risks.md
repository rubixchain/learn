---
title: Slashing Conditions and Pledging Risk
sidebar_label: Slashing Conditions and Pledging Risk
---

<!-- File: docs/validator-resources/slashing-risks.md -->
# Slashing Conditions and Pledging Risk

The Proof of Pledge (PoP) model is designed with economic accountability to prevent dishonest behavior. Validators' pledged tokens act as collateral.
